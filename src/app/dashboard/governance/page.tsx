...
import { useOneBalance, useProposals } from '@/hooks/use-sui';
                ...
                <div className="lg:col-span-4 flex flex-col gap-8">
                    ...
                    <div className="glass-card p-8 relative overflow-hidden group">
                        ...
                        <div className="mb-2">
                            ...
                            <span className="text-sm font-mono text-white/60 ml-3">vSUI</span>
                        </div>
                        <p className="text-sm text-white/60 font-medium leading-relaxed mb-8">
                            Generated by your agent squad level and staked SUI assets.
                        </p>
